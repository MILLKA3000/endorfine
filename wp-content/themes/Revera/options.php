...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Категория слайдера",
						"desc" => "Выберите категорию для слайдера",
						"id" => "w2f_slide_categories",
						"type" => "select",
						"options" => $options_categories);						
						
	$options[] = array( "name" => "Количество слайдов",
						"desc" => "Укажите количество слайдов",
						"id" => "w2f_slide_number",
						"std" => "",
						"type" => "text");							
										
	$options[] = array( "name" => "Портфолио категория",
						"desc" => "Выберите нужную категорию",
						"id" => "w2f_portfolio",
						"type" => "select",
						"options" => $options_categories);						
						
	$options[] = array( "name" => "Количество портфолио",
						"desc" => "Введите нужное количество которое будет отображаться на странице с соответствующем шаблоне",
						"id" => "w2f_port_number",
						"std" => "",
						"type" => "text");							
										

	$options[] = array( "name" => "Homepage виджеты",
						"type" => "heading");	
						
						
						
	$options[] = array( "name" => "Левый виджет заголовок",
						"desc" => "Введите название для левого виджета",
						"id" => "w2f_left_title",
						"std" => "Title goes here",
						"type" => "text");		
												
	$options[] = array( "name" => "Левый виджет текст",
						"desc" => "Введите текст для виджета",
						"id" => "w2f_left_text",
						"std" => "Text goes here",
						"type" => "textarea"); 	
						
	$options[] = array( "name" => "Левый виджет icon",
						"desc" => "Введите glyphicon name. Check http://glyphicons.getbootstrap.com/",
						"id" => "w2f_left_icon",
						"std" => "glyphicon-glass",
						"type" => "text");	
	...
	$options[] = array( "name" => "Центральный виджет заголовок",
						"desc" => "Введите название для центрального виджета",
						"id" => "w2f_middle_title",
						"std" => "Title goes here",
						"type" => "text");
						
	$options[] = array( "name" => "Центральный виджет текст",
						"desc" => "Введите текст для виджета",
						"id" => "w2f_middle_text",
						"std" => "Text goes here",
						"type" => "textarea"); 	
	...
	$options[] = array( "name" => "Правый виджет заголовок",
						"desc" => "Введите название для правого виджета",
						"id" => "w2f_right_title",
						"std" => "Title goes here",
						"type" => "text");
												
	$options[] = array( "name" => "Правый виджет текст",
						"desc" => "Введите текст для виджета",
						"id" => "w2f_right_text",
						"std" => "Text goes here",
						"type" => "textarea"); 	
						
	$options[] = array( "name" => "Правый виджет icon",
						"desc" => "Введите glyphicon name. Check http://glyphicons.getbootstrap.com/",
						"id" => "w2f_right_icon",
						"std" => "glyphicon-heart",
						"type" => "text");	
