...
// Home Boxes 	
	$wp_customize->add_section('page_boxes',array(
		...
		'description'	=> __('Select Pages from the dropdown','fitness-lite'),
		'priority'	=> null
	));
...
// Home Boxes
	...
	$wp_customize->add_section('slider_section',array(
		'title'	=> __('Slider Settings','fitness-lite'),
 			'description' => sprintf( __( 'Slider Image Size 1400x682)<br/> More slider settings available in  %s.', 'fitness-lite' ), sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( '"'.SKT_PRO_THEME_URL.'"' ), __( 'PRO Version', 'fitness-lite' )
						)
					),		
